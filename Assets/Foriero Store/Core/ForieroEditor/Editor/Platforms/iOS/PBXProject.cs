...
using System.IO;
using System;
using ForieroEditor.Platforms.iOS.Xcode.PBX;
...
namespace ForieroEditor.Platforms.iOS.Xcode
{
	...
	public enum PBXSourceTree
	{
		...
		Group,
		// The path is relative to the folder it's in. This enum is used only internally,
		// do not use it as function parameter
		Build,
		// The path is relative to the build products folder
		Developer,
		// The path is relative to the developer folder
		Sdk
		// The path is relative to the sdk folder}
